...
const Navbar = () => {
    ...
    const [isisAudioPlaying ,setIsAudioPlaying] = useState(false);
    ...
    return (
        <div ref={navContainerRef} className={"fixed inset-x-0 top-0 z-50" +
            " h-16 border-none transition-all duration-700 sm:inset-6"}>
